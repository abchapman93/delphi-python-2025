...
hint_severity_below_30= QuizHint(
    hints=[
        ...
        <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/output_filtered_severity.png" width="45%"></img>"""),
    ]
)
...
hint_change_plt_kwargs = QuizHint(
    hints=[
        ...
        <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/output_plt_kwargs.png" width="45%"></img>"""),
    ]
)
...
hint_non_parallel_lines = QuizHint(
    hints=[
        ...
        <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/output_non_parallel_lines.png" width="45%"></img>"""),
    ]
)
...
hint_non_parallel_lines_seaborn = QuizHint(
    hints=[
        widgets.HTML("""Your plot should look something like this:</br>
        <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/output_non_parallel_lines_seaborn.png" width="45%"></img>"""),
    ]
)
...
hint_distplot = QuizHint(
    hints=[
        widgets.HTML("""Your plot should look something like this:</br>
        <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/output_distplot.png" width="45%"></img>"""),
    ]
)
...
hint_pois_barh = QuizHint(
    hints=[
        widgets.HTML("""Your plot should look something like this:</br>
        <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/output_pois_barh.png" width="45%"></img>"""),
    ]
)
...
hint_severity_plot = QuizHint(
    hints=[
        widgets.HTML("""Your plot should look something like this:</br>
        <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/output_pd_severity_plot.png" width="45%"></img>"""),
    ]
)
...
age_at_discharge_viz_hint = QuizHint(description="Visualization hints",
        hints=[
            ...
            <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/age_at_discharge_hist.png"></img>
            """),
            widgets.HTML("""One option is a histogram:</br>
            <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/age_at_discharge_boxplot.png"></img>
            """),
        ]
        )
...
age_at_discharge_mortality_hint = QuizHint(description="Visualization hints",
        hints=[
            ...
            <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/age_at_discharge_proportions.png"></img>
            """)
        ]
        )
...
quiz_pna_prop = MultipleChoiceQuiz("What is the proportion of patients had pneumonia?",
...
time_to_death_viz_hint = QuizHint(description="Some hints for visualizing time to death.",
    ...
    <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/time_discharge_to_death_boxplot.png"></img>
    """),
        widgets.HTML("""Another option is a histogram:</br>:
    <img src="https://raw.githubusercontent.com/abchapman93/delphi-python-2025/refs/heads/main/media/time_to_death_hist.png"></img>
    """)
          ]
)
